...
void dir()
{
    ...
    if (access("./input/", 0))
        mkdir("./input/", S_IRWXU | S_IRWXG | S_IRWXO);
    if (access("./input/data/", 0))
        mkdir("./input/data/", S_IRWXU | S_IRWXG | S_IRWXO);
    if (access("./input/triples/", 0))
        mkdir("./input/triples/", S_IRWXU | S_IRWXG | S_IRWXO);
    if (access("./input/matrix/", 0))
        mkdir("./input/matrix/", S_IRWXU | S_IRWXG | S_IRWXO);
    if (access("./input/matrix/round/", 0))
        mkdir("./input/matrix/round/", S_IRWXU | S_IRWXG | S_IRWXO);
    if (access("./input/matrix/round/PLAIN/", 0))
        mkdir("./input/matrix/round/PLAIN/", S_IRWXU | S_IRWXG | S_IRWXO);
    if (access("./input/matrix/round/SERVER/", 0))
        mkdir("./input/matrix/round/SERVER/", S_IRWXU | S_IRWXG | S_IRWXO);
    if (access("./input/matrix/round/CLIENT/", 0))
        mkdir("./input/matrix/round/CLIENT/", S_IRWXU | S_IRWXG | S_IRWXO);
}